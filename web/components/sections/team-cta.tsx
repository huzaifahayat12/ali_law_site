import { TEAM_COPY, whatsappUrl } from "@/lib/constants";
    ...
    <section className="bg-footer-bg py-16 text-footer-fg md:py-20">
      ...
      >
        <div className="max-w-xl">
          ...
          <p className="mt-3 text-footer-fg/75">{TEAM_COPY.ctaSupport}</p>
        </div>
        <div className="flex w-full flex-col gap-3 sm:w-auto sm:flex-row">
          <ButtonLink href={whatsappUrl()} external className="w-full sm:w-auto">
            WhatsApp
          </ButtonLink>
          <ButtonLink href="/about" variant="ghost" className="w-full sm:w-auto">
            About
          </ButtonLink>
        </div>
      </div>
