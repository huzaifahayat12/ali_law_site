import { PRACTICE_COPY, whatsappUrl } from "@/lib/constants";
import { ButtonLink } from "@/components/ui/button-link";

/** Shared dark CTA band — intentional echo of home/about for site continuity. */
    ...
    <section className="bg-footer-bg py-16 text-footer-fg md:py-20">
      <div className="container-site flex flex-col items-start justify-between gap-8 md:flex-row md:items-center">
        <div className="max-w-xl">
          ...
          <p className="mt-3 text-footer-fg/75">{PRACTICE_COPY.ctaSupport}</p>
        </div>
