...
import { ABOUT_COPY, SITE } from "@/lib/constants";
  ...
  return (
    <section className="relative min-h-[70svh] overflow-hidden md:min-h-[78svh]">
      <Image
        ...
        fill
        priority
        className="pointer-events-none img-ken object-cover object-[center_18%]"
        sizes="100vw"
      />
      <div
